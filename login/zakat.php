...
<body>
    ...
    <section class="content">
        <div class="container">
            ...
            <h1 style="font-size: 40px;">Perhitungan Zakat</h1>
            <p style="color: white;">Halo <b style="color: white;"><?php echo $_SESSION['username']; ?></b> Anda telah login sebagai <b style="color: white;"><?php echo $_SESSION['level']; ?></b>.</p>
