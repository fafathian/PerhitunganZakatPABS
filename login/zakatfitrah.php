...
<body>
    ...
    <section class="content">
        <div class="container">
            <form action="zakatfitrah.php" method="post">
                <div class="form-group">
                    <label for="jumlah" style="color: white;">Jumlah Anggota Keluarga :</label>
                ...
                <div class="form-group">
                    <label for="harga" style="color: white;">Harga Beras :</label>
                    <div class="inpt input-group">
                        <span class="input-group-addon" id="harga" style="color: white;">Rp. </span>
                        <select type="number" class="form-control" id="harga" name="harga" aria-describedby="modal_">
                            <?php
                        ...
                        </select><span class="input-group-addon" id="harga" style="color: white;">/Kg </span><?php } ?>
